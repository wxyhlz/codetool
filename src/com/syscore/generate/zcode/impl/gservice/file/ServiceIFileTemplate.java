...
public class ServiceIFileTemplate implements IFileTemplate {
	...
	public String getBody(ProjectTableInfo ftInfo, CtrlFileFunDto gnDto) {
		...
		IFunTemplate funTemplate = FunInsatanceFactory.insatnceFunction("iservice");
		String resultStr = "";
	...
	public String getHeader(ProjectTableInfo ftInfo,
		...
		String servicePath = classPath.substring(0, classPath.lastIndexOf("."))+".service";
		String serviceClass = "I"+className.substring(0, className.lastIndexOf("Entity"))+"Service";
		...
		String resultStr = "/**\n"   
			...
			+ "import com.tuniu."+SonarCode.getProjectName(classPath)+".syscore.base.service.IBaseService;\n"			
			...
			+ " * @modfTime :\n" 
			+ " */\n"
			+ "public interface " + serviceClass + " extends IBaseService<" + className + ">{\n\n";
